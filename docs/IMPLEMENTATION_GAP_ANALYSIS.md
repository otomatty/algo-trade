...
**最新更新**: ニュース収集機能 Phase 1, 2, 4, 6 実装完了（2025年11月9日）、銘柄予測機能 Phase 4, 5, 6 実装完了（2025年11月9日）、銘柄予測機能 Phase 7, 8 実装完了（2025年11月9日）、データ管理機能 Phase 5 実装完了（2025年11月9日）
...
**次の優先タスク**:
1. 外部API自動収集設定UIの実装（Phase 4）
2. データセット情報カードの実装（計画にはあるが未実装）
...
2. **短期（1-2週間）**:
   - データ収集・管理の拡張機能（データ収集 Phase 4, 5、データ管理 Phase 4）
   - ニュース収集機能の拡張（Webスクレイピング、センチメント分析）
...
- **実装ガイドライン**: 
  ...
  - データ管理機能の実装方法については、`docs/03_plans/data-management/README.md` を参照してください。**Phase 1, 2, 3, 5は完了しています。Phase 4は未実装です。**
